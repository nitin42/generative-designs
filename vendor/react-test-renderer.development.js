...
;(function(global, factory) {
  ...
  function prepareToReadContext(workInProgress, renderExpirationTime) {
    ...
    if (firstContextDependency !== null) {
      ...
      // the child subtree.
      var dependency = firstContextDependency
      var hasPendingContext = false
      do {
        var _context = dependency.context
        var changedBits = isPrimaryRenderer
          ? _context._changedBits
          : _context._changedBits2
        if (changedBits !== 0) {
  ...
  function updateForwardRef(current$$1, workInProgress, renderExpirationTime) {
  ...
  function updateClassComponent(
    ...
    var hasPendingNewContext = prepareToReadContext(
      workInProgress,
      renderExpirationTime
    )
  ...
  */
  ...
  function dispatch(sourceFiber, value, expirationTime) {
    !(!isWorking || isCommitting$1)
      ? invariant(false, 'dispatch: Cannot dispatch during the render phase.')
      : void 0
  ...
  var ReactTestInstance = (function() {
    ...
    ReactTestInstance.prototype.findAllByProps = function findAllByProps(
      props
    ) {
      var options =
        arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null
  ...
  var ReactTestRenderer$1 =
    (ReactTestRenderer && ReactTestRendererFiber) || ReactTestRenderer

  // TODO: decide on the top-level export form.
  // This is hacky but makes it work with both Rollup and Jest.
  var reactTestRenderer = ReactTestRenderer$1.default
    ? ReactTestRenderer$1.default
    : ReactTestRenderer$1
