...
;(function(k, n) {
  ...
  function M(a) {
    var b = a.alternate
    if (!b) return (b = C(a)), 3 === b ? m('188') : void 0, 1 === b ? null : a
    for (var c = a, e = b; ; ) {
      var d = c.return,
  ...
  function y(a) {
    ...
    var b = p[a],
      c
    for (c in b) if (b.hasOwnProperty(c) && c in F) return (z[a] = b[c])
    return a
  }
  function G(a) {}
  function P(a, b) {
  ...
  function Q(a) {
    return function(b, c) {
      ...
      var e = H.eventNameDispatchConfigs[a],
        d = new G()
      d.target = b
      d.type = a.toLowerCase()
      var l = R.getInstanceFromNode(b),
        g = new r(e, l, d, b)
      g.persist()
      t(g, c)
      e.phasedRegistrationNames
        ? I.accumulateTwoPhaseDispatches(g)
        : I.accumulateDirectDispatches(g)
      n.unstable_batchedUpdates(function() {
        J.enqueueStateRestore(b)
        u.runEventsInBatch(g, !0)
      })
  ...
  function A() {
    f.Simulate = {}
    var a = void 0
    for (a in H.eventNameDispatchConfigs) f.Simulate[a] = Q(a)
  }
  function S(a, b) {
    return function(c, e) {
      var d = new G(a)
      t(d, e)
      f.isDOMComponent(c)
        ? ((c = T(c)), (d.target = c), K.dispatchEvent(b, d))
        : c.tagName && ((d.target = c), K.dispatchEvent(b, d))
    }
  }
  var t = k.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.assign
  t(r.prototype, {
  ...
  l &&
    ...
    'AnimationEvent' in window ||
      ...
      delete p.animationiteration.animation,
      delete p.animationstart.animation),
    'TransitionEvent' in window || delete p.transitionend.transition)
  l = y('animationend')
  var U = y('animationiteration'),
    V = y('animationstart'),
    W = y('transitionend'),
    T = n.findDOMNode,
    q = n.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED,
    u = q.EventPluginHub,
    H = q.EventPluginRegistry,
    I = q.EventPropagators,
    J = q.ReactControlledComponent,
    R = q.ReactDOMComponentTree,
    K = q.ReactDOMEventListener,
    f = {
      ...
      findAllInRenderedTree: function(a, b) {
        if (!a) return []
        f.isCompositeComponent(a) ? void 0 : m('10')
        return P(a._reactInternalFiber, b)
      },
    ...
    X = u.injection.injectEventPluginOrder
  u.injection.injectEventPluginOrder = function() {
    X.apply(this, arguments)
    A()
  }
  var Y = u.injection.injectEventPluginsByName
